...
const productosContainer2 = document.querySelector('#contenedor-productos2')
const productosContainer3 = document.querySelector('#contenedor-productos3')
...
let matches = [];
if (window.location.href.includes('abrigos')) matches = ['campera'];
